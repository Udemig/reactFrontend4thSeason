...
const renderWeatherData = (data, flagUrl, units = "metric") => {
    ...
    const speedUnit = units === "impearial" ? "mph" : "m/s"
    ...
    uiElement.weatherContainer.innerHTML = `
          <article class="weather-card">
            ...
            <div class="weather-header">
              ...
              <p id="date">${new Date().toLocaleDateString("en", {
                day: "2-digit",
                month: "long",
                year: "numeric",
              })}</p>
...
const formatTime = (unitTime, units) => {
    const d = new Date(unitTime * 1000)
...
export {uiElement, setLoader, renderWeatherData, renderRecentChips, renderError, renderCityList, updateThemeIcon, updateUnitToggle, clearError}
